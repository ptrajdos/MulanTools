...
MacroAverageMeasure {
	...
	public double getValue() {
        ...
        for (int labelIndex = 0; labelIndex < this.numOfLabels; labelIndex++) {
            sum += InformationRetrievalMeasuresPT.KappaM(this.truePositives[labelIndex], this.falsePositives[labelIndex],
	...
	public double getValue(int labelIndex) {
		return  InformationRetrievalMeasuresPT.KappaM(this.truePositives[labelIndex], this.falsePositives[labelIndex],
				this.falseNegatives[labelIndex], this.trueNegatives[labelIndex]);
	}
